declare namespace Eps {
	...
	interface MeetingReservationEntity {
		/**
		 * ID
		 */
		id?: number;
	...
	interface MeetingReservationPageResponse {
		pagination: PagePagination;
		list: MeetingReservationEntity[];
	}

	interface MeetingRoomPageResponse {
		pagination: PagePagination;
		list: MeetingRoomEntity[];
	}

	interface MeetingCommPageResponse {
		pagination: PagePagination;
		list: MeetingRoomEntity[];
	}
	...
	interface MeetingReservation {
		 ...
		 * 获取审核人列表
		 */
		getAuditors(data?: any): Promise<any>;
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<MeetingReservationEntity>;

		/**
		 * 列表查询
		 */
		list(data?: any): Promise<MeetingReservationEntity[]>;

		/**
		 * 分页查询
		 */
		page(data?: any): Promise<MeetingReservationPageResponse>;
	...
	interface MeetingRoom {
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<MeetingRoomEntity>;

		/**
		 * 列表查询
		 */
		list(data?: any): Promise<MeetingRoomEntity[]>;

		/**
		 * 分页查询
		 */
		page(data?: any): Promise<MeetingRoomPageResponse>;
	...
	interface MeetingComm {
		 ...
		 * 分页查询
		 */
		page(data?: any): Promise<MeetingCommPageResponse>;

		/**
		 * 权限标识
		 */
		permission: { getAuditors: string; list: string; page: string };

		/**
		 * 权限状态
		 */
		_permission: { getAuditors: boolean; list: boolean; page: boolean };
	...
	type Service = {
		...
		meeting: { reservation: MeetingReservation; room: MeetingRoom; comm: MeetingComm };
